...
# built documents.
#
import idmtools_git_tags
# The short X.Y version.
version = idmtools_git_tags.__version__
...
latex_documents = [
    (master_doc, 'idmtools_git_tags-docs.tex', u'idmtools_git_tags',
...
man_pages = [
    (master_doc, 'idmtools_git_tags-docs', u'idmtools_git_tags',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'idmtools_git_tags-docs', u'idmtools_git_tags',
     author, 'Clinton Collins', 'Add Git Info as tags to idmtools entities automatically',
     'Miscellaneous'),
]
